...
draw_text(_gw * 0.5, _gh * 0.22, "PAUSA");

if (menu_mode == "main") {
    var _start_y = _gh * 0.42;
    ...
    var _status = gamepad_is_connected(_slot)
        ...
        : "Controller no conectado";
    draw_set_color(gamepad_is_connected(_slot) ? c_lime : c_red);
    draw_text(_gw * 0.5, _gh * 0.36, _status);
