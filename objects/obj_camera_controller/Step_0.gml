...
//
//  Sprite 192×128, origin=(96,118) → altura visual ~118 px
//  base = 960×540, gameplay_zoom_factor = 1.25
//
//  L → zoom_reset()         vista gameplay: 1200×675  personaje 17.5 %
//                           (equivale a gameplay_zoom_factor × base)
//
//  K → zoom_to_factor(1.6)  vista boss:    1536×864   personaje 13.7 %
